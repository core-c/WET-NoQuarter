...
static const gentity_field_t gclient_fields[] = {
	...
	// ETPub uses auto_unmute_time here
	_et_gclient_addfieldalias(sess.muted, sess.auto_mute_time, FIELD_INT, 0),
	...
	/*
	 * TODO:The lines around need rework for ETPUB <-> NQ compatibility (see commented fields)
	 * - Check if we use other varnames
	 * - Check if we might add NQ related vars
	 */
	...
	// sess.aWeaponStats
	// _et_gclient_addfield(sess.aWeaponStats, FIELD_INT_ARRAY, 0),
