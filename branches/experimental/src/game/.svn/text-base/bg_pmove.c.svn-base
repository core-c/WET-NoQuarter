...
static void PM_BeginWeaponReload( int weapon ) {
	...
	switch(weapon) {
		case WP_NONE:
		case WP_AMMO:				// 12
		case WP_SMOKETRAIL:			// 16 - Smoke on arty hit as well as it's explosion
		case VERYBIGEXPLOSION:		// 17 - explosion effect for airplanes
		case WP_MEDKIT:				// 18 - Medkit 'launcher'
		case WP_BINOCULARS:			// 19 - Binoculars
		case WP_PLIERS:				// 20 - Enineer's pliers to build/repair/plant/disarm stuff
		case WP_SMOKE_MARKER:		// 21 - Airstrike marker smoke grenade
// Ammo wasn't excluded before ...
// any more weapons to skip? see PM_CheckForReload - we should do unique code here
// WP_MEDIC_SYRINGE
// WP_POISON_SYRINGE
// ...dynamite ?
		case WP_FOOTKICK:
