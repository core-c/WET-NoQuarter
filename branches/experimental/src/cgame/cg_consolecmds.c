...
static consoleCommand_t	commands[] =
 {
	...
	{ "generateTracemap",	CG_GenerateTracemap },		// core needed in NQ?
	// xkan, 11/27/2002, toggle automap on/off
	{ "ToggleAutoMap",		CG_ToggleAutomap_f },

	{ "editSpeakers",		CG_EditSpeakers_f },		// core needed in NQ?
	{ "dumpSpeaker",		CG_DumpSpeaker_f },			// IRATA needed ?
	{ "modifySpeaker",		CG_ModifySpeaker_f },		// IRATA needed ?
	{ "undoSpeaker",		CG_UndoSpeaker_f },			// core needed in NQ?
	{ "cpm",				CG_CPM_f },
