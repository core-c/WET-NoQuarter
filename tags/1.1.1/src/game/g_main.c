...
//	{ &g_HQMessages,			"g_HQMessages",				"3",								0 }, // jaquboss - 1 - we need a <class>, 2 - we've lost most of our men 	
	...
	{ &g_OmniBotNav, "omnibot_nav", "1", CVAR_ARCHIVE | CVAR_SERVERINFO_NOUPDATE | CVAR_NORESTART, 0, qfalse },
#ifdef DEBUG
...
void ServerOutput ( void )
{
	...
	if (!strstr(pakNames, "nq_bin_b1.1.1"))
		trap_SendServerCommand( -1, va("cpm \"^3|^1Warning^d: No ^2nq_bin_b1.1.1.pk3^d found on server! Missing essential files! Contact Server Admin^3|\n\"") );
