...
#define ETPUB_VERSION "1.1.1" // compatibility reasons with Omni-Bots...
#define NOQUARTER
...
typedef enum weapon_s
{
	...
	WP_FG42_SCOPE,			// 42 - Active scoped FG42
...
#define FRIENDLY_FIRE_NOLANDMINETRIGGER   0x0020  // 64   - FF is disabled near your teams spawn
