...
//Firebolt Shader
models/weapons2/firebolt/firebolt
{
	{
		map $whiteimage 
	...
	{
		map models/weapons2/firebolt/firebolt.tga
		blendfunc gl_one_minus_dst_alpha gl_src_color
		tcMod turb 0.5 0.5 0.2 0.5
		tcGen environment 
	}
	{
		map models/weapons2/firebolt/firebolt.tga
...
// jaquboss - aura 'shadows'

sprites/fastCool_aura
{
	nopicmip
	polygonOffset
	{
	...
	}
	{
		...
		tcMod stretch sin 0.50 0.05 0 0.1
		alphaGen const 0.25
		tcMod rotate 10
	}
}
