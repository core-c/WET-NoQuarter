...
//Player Culling
models/players/temperate/axis/engineer/b_engineer
{
	cull none
	implicitMap -
}

models/players/temperate/axis/cvops/b_cvops
{
	cull none
	implicitMap -
}

models/players/temperate/axis/fieldops/b_fieldops
{
	cull none
	implicitMap -
}

models/players/temperate/axis/medic/b_medic
{
	cull none
	implicitMap -
}

models/players/temperate/axis/soldier/b_soldier
{
	cull none
	implicitMap -
}
...
models/players/temperate/allied/soldier/b_soldier
{
	cull none
	implicitMap -
}
...
models/players/temperate/allied/engineer/b_engineer
{
	cull none
	implicitMap -
}
...
models/players/temperate/allied/cvops/b_cvops
{
	cull none
	implicitMap -
}
