...
weapontable_t WeaponTable[WP_NUM_WEAPONS] =
{
	...
	{	999,	0,		999,	0,		0,		0,		DELAY_VERY_LOW,	0,		0,		0,		0,							0,		0,		qfalse,	qfalse,	qfalse	},	// VERYBIGEXPLOSION			// 17
	...
	{	30,		1,		10,		20,		10,		1500,	DELAY_LOW,		400,	0,		0,		MOD_GARAND,					0,		0,		qtrue,	qtrue,	qfalse	},	// WP_GARAND				// 24		GARAND (Covert)
	...
	{	30,		1,		10,		20,		10,		2500,	DELAY_LOW,		400,	0,		0,		MOD_K43,					0,		0,		qtrue,	qtrue,	qfalse	},	// WP_K43					// 30		K43
...
int modWeaponTableMP[MOD_NUM_MODS][4] =
{
	...
	{ WP_NONE,					WP_NONE,				WP_NONE,	WP_NONE },			// MOD_KICKED,
...
gitem_t	bg_itemlist[] =
{
	...
	*/
	...
	// index 50
	{
		"weapon_kar43",
		"sound/misc/w_pkup.wav",
        { "models/multiplayer/kar98/kar98_3rd.md3", "models/multiplayer/kar98/v_kar98.md3", "models/multiplayer/mauser/mauser_pickup.md3" },
...
err:
	...
	Com_Printf("^1ERROR : ^7BG_FindItemForWeapon() ^9no item for weapon %i (%s^9)",
		weapon, (weapon >= WP_NONE && weapon < WP_NUM_WEAPONS) ? nq_wpNames[weapon] : "^1invalid");
...
#define AMMOFORWEAP	WeaponTable[item->giTag].ammoindex
...
const weap_ws_t aWeaponInfo[WS_MAX] =
{
	...
	{ WP_MEDIC_SYRINGE,			"SRNG",	"Syringe"		},	// 14 WS_SYRINGE
	{ WP_SMOKE_BOMB,			"SMOK", "SmokeScrn"		},	// 15 WS_SMOKE
	...
	{ WP_STEN_MKII,				"STN2", "Sten Mk II"	},	// 25 WS_STEN_MKII
