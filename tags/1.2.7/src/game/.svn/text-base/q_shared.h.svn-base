...
#define _GNU_SOURCE
#endif
#include "../plpa-1.3/include/plpa.h"
#endif
//---------------------
...
// This should actually be timeDelta of frames
...
// it'll make the code more transparent ... see FRAMETIME
#define	SECONDS_1			1000					// 1 sec
...
// core: CPU Affinity
qboolean C_SetAffinityCPU( int cpu, char **msg );
