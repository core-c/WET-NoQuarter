...
//	vec4_t clrTitleBck =	{ 0.16f,	0.2f,	0.17f,	0.8f	};
	...
	CG_DrawRect_FixedBorder( r->x, r->y, r->w, r->h, 1, HUD_Border/*clrBdr*/ );

	CG_FillRect( r->x + 2, r->y + 2, r->w - 4, innerheight, HUD_Background/*clrTitleBck*/ );
...
const char* awardNames[ NUM_ENDGAME_AWARDS ] = {
	...
	"Best Killing Spree",			// most kills in a killing spree
...
//	"Best Medic",					// best medic (for really real)
//	"Best Engineer",				// best engineer (for really real)
//	"Best Light Weapons Accuracy",	// best accuracy with light weapons
...
//	"Welcome Noob! Award",			// dont get this if any other award given or > 100 xp (this map)		
};
