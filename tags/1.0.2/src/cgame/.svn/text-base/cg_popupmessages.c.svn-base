...
// Battle Sense
	{ "Binoculars", 
	  ...
	  "a Helmet Chin Strap",								// Helmet doesn't pop off
...
// Signals and Logistics
	{ "Improved Resources", 							// Ammopacks contain 2x ammo
	  ...
	  "Signals Level 6",								//
	  "Signals Level 7",								// Arty and Airstrikes use less charge
...
// Light Weapons
	{ "Extra Light Weapon Ammunition",					// start with an extra clip for light weapons
	  ...
	  "Light Weapons Level 7",							//  "Offhand Grenades  Alt-fire with a weapon that has none primes a nade
	  "Light Weapons Level 8",							// 
...
// Heavy Weapons									
	{ "Extra Heavy Weapon Ammunition",					// Carry one additional belt/round 
	  ...
	  "Heavy Weapons Level 6",
	  "Additional Heavy Weapon Ammo",					// Carry aditional rpg/mortar rounds
      "Heavy Weapons Level 8",							// Heavy weapons use less charge
...
// Covert Operations
	{ "Extra Scoped Weapon Ammunition", 				// Carry an additional clip 
	  ...
	  "Increased Satchel Detonator Range",				// Satchel detonator works up to 3000 units away, rather than 2000				
