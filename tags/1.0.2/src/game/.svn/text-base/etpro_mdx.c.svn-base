...
#define	ANIM_SPEEDMAX_HIGH	20
	...
	if ( /*(ent->s.eFlags & EF_FORCE_END_FRAME) ||*/ ent->s.eType == ET_CORPSE/*ent->s.effect1Time < level.time */) { // jaquboss leave the last frame so we can do corpse animation just once
