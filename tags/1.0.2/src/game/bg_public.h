...
#define CS_VERSIONINFO					30		// Versioning info for demo playback compatibility -- TODO!!
...
#define CS_NOQUARTERINFO				40
#define CS_SKILLLEVELS					41
...
#ifdef __SSYSTEM__
#define MAX_CHARACTER_INDEXES 3 // jaquboss - for now, I don't really want small limits so this will be changed ;)
