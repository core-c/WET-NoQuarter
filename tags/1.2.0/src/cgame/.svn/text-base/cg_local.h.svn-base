...
// JPW FIXME NOTE: max_weap_banks > max_weap_banks_mp so this should be OK, but if that changes, change this too
	...
	// Meyer - Temp remove
	// matrix for computing LOD models
...
/*	qhandle_t	hintPlrFriendShader;
	...
	qhandle_t	waypointModelAttackSkin;
	qhandle_t	waypointModelDefendSkin;
	qhandle_t	waypointModelRegroupSkin;
...
typedef struct cgs_s
{
	...
	sfxHandle_t			cachedSounds[MAX_SOUNDS];
	qhandle_t			cachedModels[MAX_MODELS];
...
//	qboolean			playedLimboMusic;
	...
	//int					hitboxes;
	//	g_team*
	float				panzerRestrictions; // IRATA
	int					maxPanzers;
	int					maxMG42s;
	int					maxFlamers;
	int					maxMortars;
...
//extern	vmCvar_t		cg_gun_leftHanded;
...
#define POPUP_FILTER_SELFKILLS		0x0100	// 128	- Filter out all obituaries of self kills(of all players)
#define POPUP_FILTER_NOTOWNKILLS	0x0200	// 256	- Do NOT filter out death/kill messages of yourself
