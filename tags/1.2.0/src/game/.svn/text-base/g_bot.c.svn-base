...
int Bot_GetWeaponForClassAndTeam( int classNum, int teamNum, const char *weaponName ) {
	...
	if( !Q_stricmp( weaponName, "MP40" ) )
		...
		weapon =  WP_THOMPSON;
	else if( !Q_stricmp( weaponName, "SHOTGUN" ) )
		weapon = WP_SHOTGUN;
	...
	else if( !Q_stricmp( weaponName, "BAZOOKA" ) )
		weapon = WP_BAZOOKA;
	else if( !Q_stricmp( weaponName, "MORTAR" ) )
		weapon = WP_MORTAR;
	else if( !Q_stricmp( weaponName, "MORTAR_DEPLOYED" ) )
		weapon = WP_MORTAR_SET;
	else if( !Q_stricmp( weaponName, "MORTAR_AXIS" ) )
		weapon = WP_MORTAR2;
	else if( !Q_stricmp( weaponName, "MORTAR_DEPLOYED_AXIS" ) )
		weapon = WP_MORTAR2_SET;
