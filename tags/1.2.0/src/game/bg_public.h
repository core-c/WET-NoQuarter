...
#define ETPUB_VERSION "1.2.0" // compatibility reasons with Omni-Bots...
#define NOQUARTER
...
#define JP_INSANITY_NUM_MODES	9
...
#define REALISM_STUN				4	// player can be stunned when he is hit, this will result in screen blacken, movement disadvantage, pain animation, and no shooting for a bit
