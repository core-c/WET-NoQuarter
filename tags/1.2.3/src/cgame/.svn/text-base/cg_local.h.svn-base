...
// JPW FIXME NOTE: max_weap_banks > max_weap_banks_mp so this should be OK, but if that changes, change this too
	...
	//int			selectedBotClientNumber[MAX_NUM_BUDDY]; //crapshoot: removed
	// END		xkan, 8/29/2002
	int			binocZoomTime;
	...
	// int			botMenuIcons; // crapshoot: removed
	//		And we need to know which one is the selected one
	// int			botSelectedCommand; // crapshoot: removed
	...
	// IlDuca - this variable seems not used ...
	//int				noquarter;
...
// OSP
	...
	sfxHandle_t	sfx_artilleryDist_1[1];
...
//int CG_GetFirstSelectedBot(); // crapshoot: removed
//void CG_AddToJournal(char *text); // crapshoot: removed
...
#define POPUP_FILTER_NOTOWNKILLS	0x0100	// 256	- Do NOT filter out death/kill messages of yourself
