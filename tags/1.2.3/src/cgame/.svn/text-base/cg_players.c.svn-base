...
void CG_Player( centity_t *cent )
{
	...
	int				lodBias = (int)CG_Cvar_Get( "r_lodbias" );
	float			dist = VectorDistance(cent->currentState.origin, cg.refdef_current->vieworg);
...
// Meyer - Temp change
	if( cent->currentState.eType != ET_CORPSE && !(cent->currentState.eFlags & EF_PLAYDEAD) && lodBias <= 0 && dist < 1024) {
