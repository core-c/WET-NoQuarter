...
//	cgs.smokeWindDir = crandom();
	...
	// Setup smoke colors
	Vector4Set(cgs.smokeColor_Axis,		0.6,	0.1,	0.1,	0.0);
	Vector4Set(cgs.smokeMod_Axis,		0.1,	0.0,	0.0,	0.5);
	Vector4Set(cgs.smokeColor_Allies,	0.1,	0.1,	0.6,	0.0);
	Vector4Set(cgs.smokeMod_Allies,		0.0,	0.0,	0.1,	0.5);
	Vector4Set(cgs.smokeColor_Neutral,	0.5,	0.5,	0.5,	0.0);
	Vector4Set(cgs.smokeMod_Neutral,	0.25,	0.25,	0.25,	0.5);
}
