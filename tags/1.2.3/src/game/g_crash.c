...
void CrashHandler(int signal, siginfo_t *siginfo, ucontext_t *ctx) {
	...
	if(segvloop < 2) {
		...
		G_CrashLogPrintf("---------------------------------------\n");
		G_LogPrintf("Version: %s %s %s Linux\n", GAMEVERSION, ETPUB_VERSION, __DATE__);
		G_CrashLogPrintf("Version: %s %s %s Linux\n", GAMEVERSION, ETPUB_VERSION, __DATE__);
...
void win32_exceptioninfo(LPEXCEPTION_POINTERS e) {
	...
	G_CrashLogPrintf("Exception Address: 0x%08x\n", (unsigned int)e->ExceptionRecord->ExceptionAddress);
}
...
LONG CALLBACK win32_exception_handler(LPEXCEPTION_POINTERS e) {
	...
	G_CrashLogPrintf("   Please forward to No Quarter mod team.   \n");
	G_CrashLogPrintf("---------------------------------------\n");
	G_LogPrintf("Version: %s %s %s Win32\n", GAMEVERSION, ETPUB_VERSION, __DATE__);
	G_CrashLogPrintf("Version: %s %s %s Win32\n", GAMEVERSION, ETPUB_VERSION, __DATE__);
	G_CrashLogPrintf("Map: %s\n",level.rawmapname);
