...
void ClientUserinfoChanged( int clientNum ) {
	...
	s = va( "n\\%s\\t\\%i\\c\\%i\\r\\%i\\m\\%s\\s\\%s\\dn\\%s\\dr\\%i\\w\\%i\\lw\\%i\\sw\\%i\\mu\\%i\\ref\\%i\\rn\\%i\\lc\\%i\\xp\\%s\\uci\\%u",
		client->pers.netname,
		...
		qboolean restoreHealth)
{
	...
	int			savedPing;
	int			savedTeam;
	//int			savedSlotNumber; // crapshoot: removed
...
//unlagged
	...
	//savedSlotNumber	= client->botSlotNumber; // crapshoot: removed
	...
	// START	xkan, 8/27/2002
	//client->botSlotNumber	= savedSlotNumber; // crapshoot: removed
	// END		xkan, 8/27/2002
