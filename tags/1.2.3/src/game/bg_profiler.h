...
// IRATA type not used: #define PROFILE_ENTITY_TYPE_ET_BOTGOAL_INDICATOR	(PROFILE_ENTITY_TYPE_BASE + ET_BOTGOAL_INDICATOR)
...
//#define PROFILE_EV_BOT_DEBUG_LINE					(PROFILE_ENTITY_EVENT + EV_BOT_DEBUG_LINE)			//crapshoot: unused
//#define PROFILE_EV_BOT_DEBUG_RADIUS					(PROFILE_ENTITY_EVENT + EV_BOT_DEBUG_RADIUS)		//crapshoot: unused
