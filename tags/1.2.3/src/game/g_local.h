...
// jaquboss
	...
	// int                  ´nextReliableTime; // IRATA old pub var not used
};
...
// ===================
	...
	// int		whineTime; // to whine about wrong server installation // IRATA removed
	// int		pk3whine; // with the thing bellow to do not open pk3 all the time // IRATA removed
...
// StM: changed to adrenaline flag
