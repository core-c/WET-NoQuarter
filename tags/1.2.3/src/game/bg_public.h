...
#define ETPUB_VERSION "1.2.3" // compatibility reasons with Omni-Bots...
#define NOQUARTER
...
// #define DEBUG_BOT_RETREATBEHAVIOR	1 // crapshoot: removed
...
#define MAX_FIRETEAM_MEMBERS		6	// jP raised max fireteam members to 8 from 6 - Meyer reduced back to 6 to avoid overlapping UI elements.
#define MAX_SHOTGUN_PELLETS			10
#define SHOTGUN_SPREAD  			600
// jaquboss - how long it takes knives to fully charge
...
typedef enum {
	...
	// PM_JETPILOT,		// jet Pilot Movement! IRATA not set so unused
} pmtype_t;
...
// jaquboss - @fixme these are !WASTE!, used to determinate animation,
// but they are set at SAME point, so they are pointLESS
...
//#define	PMF_STUNNED		8192	// hold for this time after a load game, and prevent large thinks
...
typedef enum {
	...
	PERS_AWARDS,					// (0-255 each) Goombas, Darwin Awards,
...
typedef enum weapon_s
{
	...
	// WP_TRIPMINE,			// 28 - tripmine, unused, not finished
	WP_SMOKE_BOMB,			// 29 - Covert's smoke grenade
	WP_MOBILE_MG42,			// 30 - Mobile MG42
	WP_K43,					// 31 - Covert's K43
	WP_FG42,				// 32 - FG42
	WP_DUMMY_MG42,          // 33 - storing heat on mounted mg42s
	WP_MORTAR,				// 34 - Allied Mortar
	WP_AKIMBO_COLT,			// 35 - akimbo colts
	WP_AKIMBO_LUGER,		// 36 - akimbo lugers
	WP_GPG40,				// 37 - Grenade launcher for K43
	WP_M7,					// 38 - grenade launcher for M1 Garand
	WP_SILENCED_COLT,		// 39 - Colt with silencer on
	WP_GARAND_SCOPE,		// 40 - Active scoped M1 Garand
	WP_K43_SCOPE,			// 41 - Active scoped K43
	WP_FG42SCOPE,			// 42 - Active scoped FG42
	WP_MORTAR_SET,			// 43 - deployed mortar
	WP_MEDIC_ADRENALINE,	// 44 - adrenaline syringe
	WP_AKIMBO_SILENCEDCOLT,	// 45 - akimbo silenced colts
	WP_AKIMBO_SILENCEDLUGER,// 46 - akimbo silenced lugers
	WP_MOBILE_MG42_SET,		// 47 - deployed MG42
	WP_SHOTGUN,				// 48 - Winchester Model 1897 12-gauge
	WP_KNIFE_KABAR,			// 49 - US KABAR Combat Knife
	WP_MOBILE_BROWNING,		// 50 - Browning .30 Light Machinegun
	WP_MOBILE_BROWNING_SET,	// 51 - (as above with bipod deployed)
	WP_BAR,					// 52 - Browning Automatic Rifle
	WP_BAR_SET,				// 53 - (as above with bipod deployed)
	WP_STG44,				// 54 - Sturmgewehr 44 Assault Rifle
	WP_STEN_MKII,			// 55 - Sten MkII SMG (unsilenced)
	WP_BAZOOKA,				// 56 - M1 Bazooka Anti-Tank
	WP_MP34,				// 57 - Solothurn S1-100 SMG
	//WP_FIREBOLT,			// 58 - insanity weapon
	WP_MORTAR2,				// 59 - Axis mortar
	WP_MORTAR2_SET,			// 60 - deployed Axis mortar
	WP_VENOM,				// 61 - Venom machinegun
	WP_POISON_SYRINGE,		// 62 - poisoned syringe
...
#define IS_NONFLASH_WEAPON(w) \
	(	w == WP_GRENADE_LAUNCHER	|| w == WP_GRENADE_PINEAPPLE	|| \
		...
		w == WP_SMOKE_MARKER		|| w == WP_POISON_SYRINGE		/*|| w == WP_FIREBOLT*/	 )
...
//	EV_GIVEPAGE,
	...
	EV_THROWKNIFE,
	EV_SHOVE_SOUND,
	EV_BOT_DEBUG_LINE,			// crapshoot: unused
	EV_BOT_DEBUG_RADIUS,		// crapshoot: unused
	EV_WEAPALT,
	EV_PRIVATE_MESSAGE,
	EV_SHOTGUN_FIRED,
	EV_ARTY_DETECTED,
...
//#define MAX_BOTS			64		//crapshoot: removed
//#define MAX_BOTS_TEXT		8192	//crapshoot: removed
...
#define REALISM_POISONED_DROPGUN	4	// if someone is poisoned, he drops primary and secondary weapons
...
// jaquboss - saving configstings
extern const char* gameSounds[];
extern const char* gameModels[];

#define ADF_NOSPAWN 1
#define ADF_NOPACK	2
#define ADF_JUSTONE 4
#define ADF_NOHEALTH 8
#define ADF_NOSTAMINA 16
#define ADF_EYEGLOW 32
#define ADF_NOHPICK 64
#define ADF_SOLDIER 128 // StM adrenaline class limit
#define ADF_MEDIC 256
#define ADF_ENGINEER 512
#define ADF_FIELDOPS 1024
#define ADF_COVERTOPS 2048
