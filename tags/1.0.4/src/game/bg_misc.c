...
#define MISC_UW_AMMO_RESTORES_HELMET 0 // josh: no client mod
#elif GAMEDLL
	extern	vmCvar_t g_developer;
	extern	vmCvar_t g_gametype;
#define gametypeCvar g_gametype
  extern vmCvar_t g_weapons;
#define MISC_UW_AMMO_RESTORES_HELMET \
    (g_weapons.integer & WPF_AMMO_RESTORES_HELMET)
#else
	extern	vmCvar_t ui_gameType;
#define MISC_UW_AMMO_RESTORES_HELMET 0 // josh: no ui stuff here
...
int jP_GrenadesPerLevel[SK_NUM_SKILLS][NUM_SKILL_LEVELS] =
{
	...
	{	4,	8,	8,	8,	8,	8,	8,	8,	8, 10	},		// Engineer
	{	1,	2,	2,	2,	2,	2,	3,	3,	3,	3	},		// Medic
	{	1,	2,	2,	2,	2,	2,	3,	3,	3,	3	},		// Signals
	{	0,	0,	0,	0,	0,	1,	1,	1,	2,	2	},		// Light Weapons (Bonus)
	{	4,	4,	4,	4,	4,	6,	8,	8,	8,	8	},		// Heavy Weapons
	{	2,	2,	2,	2,	2,	3,	3,	3,	3,	3	},		// Covert Ops
};
...
void BG_PlayerStateToEntityState( playerState_t *ps, entityState_t *s, int time, qboolean snap )
{
	...
	if(ps->stats[STAT_HEALTH] <= 0 && !(ps->eFlags & EF_PLAYDEAD)) 
	{
		s->eFlags |= EF_DEAD;
	} 
	else 
...
//	s->loopSound = ps->loopSound;
	...
	// jet Pilot - leaning - hijack constantLight (from FalkonET)
/*	if (ps->leanf)
	{
