...
//#define RTCWSHAKE  -- jaquboss - enable to have RTCW like explosions shake, they are mightier, instead of moving camera this changes angles
...
typedef struct clientInfo_s
{
	...
	// jet Pilot - RTCW/ETPro style location index
#ifdef USELOCATIONS
	int				locationIndex[2];		
	char			locationName[64];
	float			leanAmount;			// amount of lean
#endif
	int				health;				// you only get this info about your teammates
	int				curWeapon;			// current weapon?
	...
	int				disguiseRank;
	int				disguiseClient; // jaquboss

	int				weapon;
	int				secondaryweapon;
	int				latchedweapon;
	int				rifleNade; // jaquboss
...
//	qboolean	changeSkin;			// jaquboss, to prevent sleeve models changing skins when unwanted
} partModel_t;
...
// JPW FIXME NOTE: max_weap_banks > max_weap_banks_mp so this should be OK, but if that changes, change this too
...
#ifdef USELOCATIONS
	qboolean		editingLocations;		// jet Pilot - in game location editor GUI
#endif
	...
	specName_t		specOnScreenNames[16];
	int				specOnScreenNamesNum;
...
/*	qhandle_t	gibAbdomen;
	...
	// jet Pilot - gib models
//	qhandle_t	gibModels[MAX_GIB_MODELS]; //   = trap_R_RegisterModel   ( "models/gibs/foot.md3"   );
...
//	qhandle_t	bfgExplosionShader; WTF? there wasn't cleanup since Q3 :|
...
//	qhandle_t	onScreenColorShader;

	qhandle_t	jetModel[2];
	qhandle_t	jetSkin[2];
...
//	qhandle_t		hintKey;
	...
	// jet Pilot - cgMedia_t - Added new icons

/*	qhandle_t		limboSkillLevel1;
	qhandle_t		limboSkillLevel2;
	qhandle_t		limboSkillLevel3;
	qhandle_t		limboSkillLevel4;
	qhandle_t		limboSkillLevel5;
	qhandle_t		limboSkillLevel6;
	qhandle_t		limboSkillLevel7;
	qhandle_t		limboSkillLevel8;
	qhandle_t		limboSkillLevel9;
	qhandle_t		limboSkillLevel[11];
	*/

//	qhandle_t		hintDanger;
	
	sfxHandle_t		goombaSound;
//	sfxhandle_t		spreeSound[10];
	...
	//qhandle_t		runeicons[10];			// for runeET game
...
#define JP_EXTRA_STRINGS 3 // default is 2
...
#define NUM_ENDGAME_AWARDS 14//12	// jet Pilot - Reduced Endgame Awards - for now


#ifdef USELOCATIONS
// jet Pilot - added location structure
...
#else
// jaquboss new clientSide locations
#define MAX_C_LOCATIONS 256
...
//	qboolean			playedLimboMusic;
	...
	int					mvAllowed;
#endif
	// jet Pilot - server controlled smoke colors
	vec4_t				smokeColor_Axis;	
	vec4_t				smokeColor_Allies;
	vec4_t				smokeColor_Neutral;
	vec4_t				smokeMod_Axis; 			
	vec4_t				smokeMod_Allies;		
	vec4_t				smokeMod_Neutral;
	...
	int					numWeaponScriptsDir;
	char				weaponScriptsDir[16][MAX_CVAR_VALUE_STRING];
#ifdef __SSYSTEM__
	qboolean			limboPcInfoModifed;
	qboolean			limboDrawCharacter;
	playerCharacter_t	limboPcInfo[NUM_PLAYER_CLASSES][2];
	playerInfo_t		renderedPlayerInfo;
#endif
	
	int					fixedphysics;
	int					fixedphysicsfps;
	//char				configName[MAX_STRING_TOKENS];
...
extern	vmCvar_t		cg_test1;
extern	vmCvar_t		cg_test2;
extern	vmCvar_t		cg_test3;
...
// jet Pilot - cvar external declaration

extern	vmCvar_t		cg_goatSound;

//extern	vmCvar_t		cg_doubleJump;
//extern	vmCvar_t		cg_doubleJumpWindow;
//extern	vmCvar_t		cg_doubleJumpScale;
//extern	vmCvar_t		cg_doubleJumpHeight;
extern	vmCvar_t		cg_weaponsCvar;//jaquboss, we need this for prediction correction
extern	vmCvar_t		cg_HUDBackgroundColor;
extern	vmCvar_t		cg_HUDBorderColor;
extern  vmCvar_t		cg_HUDAlpha;
extern  vmCvar_t		cg_hitSounds;
extern  vmCvar_t		r_dynamicTextures;
extern  vmCvar_t		cg_drawHUDHead;
extern	vmCvar_t		cg_drawObjIcons;
extern	vmCvar_t		cg_charSizeLarge;
extern	vmCvar_t		cg_charSizeSmall;
extern	vmCvar_t		cg_charSizeTiny;
...
#ifdef USELOCATIONS
extern	vmCvar_t		cg_drawLocations;
extern  vmCvar_t		cg_useLocations;
#endif
...
extern	vmCvar_t		hud_powerupX;
extern	vmCvar_t		hud_powerupY;
extern	vmCvar_t		hud_powerupRows;
...
extern vmCvar_t		cg_atmosphereRenderDistance;
...
extern vmCvar_t	cg_classAutoexec;
extern vmCvar_t	cg_teamAutoexec;
extern vmCvar_t	cg_rtcwShake;
extern vmCvar_t	cg_weapAltReload;
...
#ifdef USELOCATIONS
void CG_LocationEditorDraw( void );
#endif
...
extern char		locationName[256][64];
#endif
...
qboolean CG_WorldCoordToScreenCoordFloat ( vec3_t worldCoord, float *x, float *y ); // jaquboss from JKA, projects point in world on screen
