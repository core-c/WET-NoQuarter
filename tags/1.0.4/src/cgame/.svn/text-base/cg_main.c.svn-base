...
//vmCvar_t		cg_doubleJumpHeight;
vmCvar_t		cg_weaponsCvar; // jaquboss
...
#ifdef USELOCATIONS
vmCvar_t		cg_drawLocations;
vmCvar_t		cg_useLocations;
#endif
...
//	{ &cg_doubleJump,			"g_doubleJump",					"1",		CVAR_SERVERINFO	},
//	{ &cg_doubleJumpHeight,		"g_doubleJumpHeight",			"1.4",		CVAR_SERVERINFO	},
	{ &cg_weaponsCvar,			"",			"",			0	},
	{ &cg_insanity,				"",			"0",		0	},
	...
	{ &hud_drawAltHUD,			"hud_drawAltHUD",				"1",		CVAR_ARCHIVE | CVAR_USERINFO	}, // jaquboss

	{ &cg_drawMuzzleFlash,		"cg_drawMuzzleFlash",			"1",		CVAR_ARCHIVE	},
	{ &cg_drawTracers,			"cg_drawTracers",				"1",		CVAR_ARCHIVE	},

#ifdef USELOCATIONS
	{ &cg_useLocations,			"cg_useLocations",				"0",		CVAR_ARCHIVE	},
	{ &cg_drawLocations,		"cg_drawLocations",				"0",		0	},
#endif
...
// jaquboss - @fixme, crandom is always the same here
	...
	//CG_SendPCInfo( cgs.clientinfo[cg.clientNum].cls, cgs.clientinfo[cg.clientNum].team );
#endif
