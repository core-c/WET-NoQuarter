...
typedef enum {
	...
	STAT_LEANING,
	STAT_IDENTIFYAMMO,				// jaquboss, quite a suitable place :P
	STAT_IDENTIFYCLIP,
} statIndex_t;
...
#define FRIENDLY_FIRE_NOLANDMINETRIGGER   0x0040  // 64   - FF is disabled near your teams spawn
...
#define	SPEC_PLAYERGLOW 2
#define	SPEC_SHOWNAMES	4
