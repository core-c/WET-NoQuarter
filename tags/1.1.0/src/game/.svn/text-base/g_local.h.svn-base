...
*/
	...
	int					executions;
	int					spreeLevel;			// jaquboss - hier es macht gut!
...
#define MEDIC_NOSELFADREN			128  // medics does not recieve adrenaline
...
#define G_FRIENDLYFIRE (!(g_friendlyFire.integer & FRIENDLY_FIRE_DISABLED) && g_friendlyFire.integer > 0 )