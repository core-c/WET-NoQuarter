...
void Cmd_SwapPlacesWithBot_f( gentity_t *ent, int botNum ) {
 ...
 qboolean ClientIsFlooding(gentity_t *ent) { 
	...
	ent->client->nextReliableTime = level.time + 1000;
	return qfalse;
