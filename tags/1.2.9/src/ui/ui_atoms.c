/*
 * name:	ui_atoms.c - Copyright (C) 1999-2000 Id Software, Inc.
 *
 * desc:	User interface building blocks and support functions.
 *
 * NQQS:	healthy
 *
 */
...
void UI_DrawNamedPic( float x, float y, float width, float height, const char *picname ) {
	qhandle_t	hShader = trap_R_RegisterShaderNoMip( picname );
