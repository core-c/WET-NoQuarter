...
// TODO: FIXME:  REMOVE REGISTRATION OF EACH MODEL FOR EVERY LEVEL LOAD
	...
	for( i = WP_KNIFE; i < WP_NUM_WEAPONS; i++ ) {
		...
		if ( BG_WeaponInWolfMP(i) /*|| i == WP_MAPMORTAR*/ ){
...
// jaquboss - @fixme, crandom is always the same here
	...
	// jaquboss copied here so game select best secondary 
/*	if ( cgs.clientinfo[ cg.clientNum ].skill[SK_SOLDIER] >= 4 && cgs.clientinfo[ cg.clientNum ].cls == PC_SOLDIER ){
