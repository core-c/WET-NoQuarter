...
#ifdef __SSYSTEM__
	//if ( cgs.limboPcInfoModifed )
	{
		trap_SendClientCommand( va( "pcinfo %i %i %i %i %i %i %i %i %i %i %i %i %i %i %i\n", 
			cgs.limboPcInfo[CG_LimboPanel_GetClass()][CG_LimboPanel_GetTeam()-1].headIndex,
			cgs.limboPcInfo[CG_LimboPanel_GetClass()][CG_LimboPanel_GetTeam()-1].faceIndex,
			cgs.limboPcInfo[CG_LimboPanel_GetClass()][CG_LimboPanel_GetTeam()-1].bodyIndex,
			cgs.limboPcInfo[CG_LimboPanel_GetClass()][CG_LimboPanel_GetTeam()-1].torsoIndex,
			cgs.limboPcInfo[CG_LimboPanel_GetClass()][CG_LimboPanel_GetTeam()-1].legIndex,
			cgs.limboPcInfo[CG_LimboPanel_GetClass()][CG_LimboPanel_GetTeam()-1].helmetIndex,
			cgs.limboPcInfo[CG_LimboPanel_GetClass()][CG_LimboPanel_GetTeam()-1].helmetSkinIndex,
			cgs.limboPcInfo[CG_LimboPanel_GetClass()][CG_LimboPanel_GetTeam()-1].backPackIndex,
			cgs.limboPcInfo[CG_LimboPanel_GetClass()][CG_LimboPanel_GetTeam()-1].backPackSkinIndex,
			cgs.limboPcInfo[CG_LimboPanel_GetClass()][CG_LimboPanel_GetTeam()-1].bLeftIndex,
			cgs.limboPcInfo[CG_LimboPanel_GetClass()][CG_LimboPanel_GetTeam()-1].bLeftSkinIndex,
			cgs.limboPcInfo[CG_LimboPanel_GetClass()][CG_LimboPanel_GetTeam()-1].bRightIndex,
			cgs.limboPcInfo[CG_LimboPanel_GetClass()][CG_LimboPanel_GetTeam()-1].bRightSkinIndex,
			cgs.limboPcInfo[CG_LimboPanel_GetClass()][CG_LimboPanel_GetTeam()-1].glassIndex,
			cgs.limboPcInfo[CG_LimboPanel_GetClass()][CG_LimboPanel_GetTeam()-1].glassSkinIndex
			) );
	}
#endif
...
void CG_DrawPlayerHead( rectDef_t *rect, bg_character_t* character, bg_character_t* headcharacter, float yaw, float pitch, qboolean drawHat, hudHeadAnimNumber_t animation, qhandle_t painSkin, clientInfo_t *ci, qboolean spectator, int team ) 
{
	float			len;
	vec3_t			origin;
...
//		CG_DrawPlayerHead( &button->rect, CG_LimboPanel_GetCharacter(), CG_LimboPanel_GetCharacter(), 180, 0, qtrue, HD_IDLE4, 0, cgs.clientinfo[ cg.clientNum ].rank, qfalse );
		// jet Pilot - Modified CG_DrawPlayerHead
		CG_DrawPlayerHead( &button->rect, CG_LimboPanel_GetCharacter(), CG_LimboPanel_GetCharacter(), 180, 0, qtrue, HD_IDLE4, 0, &cgs.clientinfo[ cg.clientNum ], qfalse, CG_LimboPanel_GetTeam() );
	} else {
	...
	for( i = 0; i < MAX_CLIENTS; i++ ) {
		...
		if( weap != -1 ) {
			...
			if ( weap == WP_M7 || weap == WP_GPG40 ){
				if ( !cgs.clientinfo[i].rifleNade || ( cgs.clientinfo[i].weapon != weapAlts[weap] && cgs.clientinfo[i].latchedweapon != weapAlts[weap] ) ) continue; // jaquboss added case for non rifle owners
