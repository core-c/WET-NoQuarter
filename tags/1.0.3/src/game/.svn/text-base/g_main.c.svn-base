...
void ServerOutput ( void )
{
	...
	if (!strstr(pakNames, "nq_bin_b1.0.3"))
		trap_SendServerCommand( -1, va("cpm \"^3No nq_bin_b1.0.3.pk3 found on server ( using wrong files ? ) contact server Admin\n\"") );


	if (strstr(pakNames, "nq_bin_b1.0.2"))
