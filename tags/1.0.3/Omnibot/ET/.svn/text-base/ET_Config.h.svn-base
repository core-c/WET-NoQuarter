...
// $LastChangedDate: 2006-05-22 17:02:12 -0400 (Mon, 22 May 2006) $
...
//#ifdef NOQUARTER
	...
	ET_WP_BAR_SET,
	ET_WP_STG44,
	ET_WP_MOBILE_BROWNING,
	ET_WP_MOBILE_BROWNING_SET,
	ET_WP_BAZOOKA,
	ET_WP_MORTAR2,
	ET_WP_MORTAR2_SET,
	ET_WP_SHOTGUN,
...
typedef enum eET_GoalType
{
	...
	ET_GOAL_VEHICLE,		// a vehicle
	ET_GOAL_MG42MOUNT,		// a mountable mg42
	ET_GOAL_SNIPERSPOT,		// a sniper spot
	...
	ET_GOAL_FLAG,			// grabbable, cappable flag
	ET_GOAL_CAPPOINT,		// place to capture flag
...
typedef enum eET_EntityFlags
{
	...
	ET_ENT_FLAG_DISGUISED	= (ENT_FLAG_FIRST_USER<<0),	
	// bit: ET_ENT_MOUNTED
	//		This entity is mounted on an mg42, tank, or aagun
	ET_ENT_FLAG_MOUNTED		= (ENT_FLAG_FIRST_USER<<1),
	// bit: ET_ENT_FLAG_MNT_MG42
	//		Currently mounted on an mg42
	ET_ENT_FLAG_MNT_MG42		= (ENT_FLAG_FIRST_USER<<2),
	// bit: ET_ENT_FLAG_MNT_TANK
	//		Currently mounted on a tank
	ET_ENT_FLAG_MNT_TANK		= (ENT_FLAG_FIRST_USER<<3),
	// bit: ET_ENT_FLAG_MNT_AAGUN
	//		Currently mounted on an aa gun
	ET_ENT_FLAG_MNT_AAGUN		= (ENT_FLAG_FIRST_USER<<4),
	// bit: ET_ENT_FLAG_CARRYINGGOAL
	//		This entity is carrying a goal of some sort
	ET_ENT_FLAG_CARRYINGGOAL= (ENT_FLAG_FIRST_USER<<5),
	// bit: ET_ENT_FLAG_INLIMBO
	//		This entity is currently in limbo mode. Players only.
	ET_ENT_FLAG_INLIMBO		= (ENT_FLAG_FIRST_USER<<6),
	// bit: ET_ENT_FLAG_ISMOUNTABLE
	//		This entity is mountable.
	ET_ENT_FLAG_ISMOUNTABLE	= (ENT_FLAG_FIRST_USER<<7),	
	// bit: ET_ENT_FLAG_EXPLOSIVEDAMAGEONLY
	//		This entity can only be hurt by explosive damage.
	ET_ENT_FLAG_EXPLOSIVEDAMAGEONLY	= (ENT_FLAG_FIRST_USER<<8),	
} ET_EntityFlags;
