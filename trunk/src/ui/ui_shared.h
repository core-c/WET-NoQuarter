...
#define MAX_MENUS 256	//128
#define MAX_MENUITEMS 256 //128 // JPW NERVE q3ta was 96
...
#define WINDOW_SCROLLING		0x80000000
...
typedef struct itemDef_s {
	...
	// core: checkbox for bitflags in an integer cvar. The value it has is the bitvalue (1,2,4,8 etc)
	int bitflag;
} itemDef_t;
...
// void Display_ExpandMacros(char * buff); // IRATA: not implemented
...
// qboolean Script_Parse(char **p, const char **out); // IRATA: not implemented
