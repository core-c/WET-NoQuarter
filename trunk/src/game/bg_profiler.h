...
// core: for compiling without profiler support..
//       server-admins will never use it anyway,
//       it's just for the debuggers.
//#undef PROFILER
//       The directive should be added to the
//       Windows-(game)project file (like GAMEDLL etc)
...
#define PROFILE_RUN_ENTITY_STAGE_1		7
#define PROFILE_RUN_ENTITY_STAGE_2		8
#define PROFILE_RUN_ENTITY_STAGE_3		9
#define PROFILE_RUN_ENTITY_STAGE_4		10
#define PROFILE_RUN_ENTITY_STAGE_5		11
#define PROFILE_RUN_ENTITY_STAGE_6		12
#define PROFILE_RUN_ENTITY_STAGE_7		13
#define PROFILE_RUN_ENTITY_STAGE_8		14
#define PROFILE_RUN_ENTITY_STAGE_9		15
#define PROFILE_RUN_ENTITY_STAGE_10		16

#define PROFILER_G_Script_ScriptRun		17
#define PROFILER_G_RunMissile			18
#define PROFILER_G_RunThink				19
#define PROFILER_G_RunFlamechunk		20
#define PROFILER_G_RunItem				21
#define PROFILER_G_RunMover				22
#define PROFILER_G_RunClient			23

#define PROFILE_ENTITY_TYPE_BASE		24
...
#define PROFILE_EV_PRIVATE_MESSAGE		(PROFILE_ENTITY_EVENT + EV_PRIVATE_MESSAGE)
#define PROFILE_EV_SHOTGUN_FIRED		(PROFILE_ENTITY_EVENT + EV_SHOTGUN_FIRED)
#define PROFILE_EV_ARTY_DETECTED		(PROFILE_ENTITY_EVENT + EV_ARTY_DETECTED)
#define PROFILE_EV_MISSIONMESSAGE		(PROFILE_ENTITY_EVENT + EV_MISSIONMESSAGE)
