...
#define SBF_NOVOTE					'?'	// IlDuca - frodon patch : flag to control vote permissions
...
qboolean G_shrubbot_dropweapon (gentity_t *ent, int skiparg); // IRATA
qboolean G_shrubbot_weapons (gentity_t *ent, int skiparg); // IRATA
...
qboolean G_shrubbot_setlevel_lua(int slot, int shrublevel);
...
// void G_shrubbot_writeconfig_float(float v, fileHandle_t f); // IRATA: unused
